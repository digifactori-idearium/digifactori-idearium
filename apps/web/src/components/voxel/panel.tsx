    ...
    >
      ...
      {formeSelect.longueur && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <label style={{ fontSize: 14 }}>🔢 Longueur des formes :</label>
      ...
      {formeSelect.largeur && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <label style={{ fontSize: 14 }}>🔢 Largueur des formes :</label>
      ...
      {formeSelect.hauteur && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <label style={{ fontSize: 14 }}>🔢 Hauteur des formes :</label>
