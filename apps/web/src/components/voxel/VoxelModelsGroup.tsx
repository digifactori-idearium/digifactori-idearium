        ...
        <>
                ...
                {models.map((model, index) => (
                    ...
                    >
                        <CardContent className="px-0">
                            <div className="aspect-video w-full bg-gradient-to-br from-purple-400 to-indigo-500 flex items-center justify-center">
            ...
            {modelToDelete && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                    <div className="bg-sidebar rounded-2xl p-6 shadow-xl border border-mauve/20 max-w-md w-full mx-4">
                        <h2 className="text-xl font-bold mb-3">Supprimer le modèle</h2>
                        <p className="mb-5">
                            Veux-tu vraiment supprimer <strong>{modelToDelete.name}</strong> ?
                        </p>
